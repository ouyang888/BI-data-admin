...
export default{
  ...
  methods: {
    ...
    getSummaries(){
          ...
          if(this.tAvgAmtArr.includes(this.router)){ /*路由存在则添加责任制金额值*/
            arrContent.unshift(this.endObj[this.headerObj.tAvgAmt] && this.endObj[this.headerObj.tAvgAmt].toFixed(2) || 0);
          }
