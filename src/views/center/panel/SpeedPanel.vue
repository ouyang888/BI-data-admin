<template>
  <div class="panel-content">
    ...
    <div class="bottom">
      <p>
        <span>{{data.bottomTitle1}}：</span><span style="margin-right:6px;">完成率:{{data.bottomClose}}%</span><span>进度：{{data.bottomTime}}%</span>
      </p>
      <p>
        <span>{{data.bottomTitle2}}：</span><span style="margin-right:6px;">完成率:{{data.bottomClose1}}%</span><span>进度：{{data.bottomTime1}}%</span>
      </p>
