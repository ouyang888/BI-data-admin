<template>
    <div style="background: #02004d">
      ...
      <div class="top-flex"  >
        ...
        <div class="flex-card" >
          <div class="card-box">
            <div class="card-font" @click="toModuleResponsible">京东自营店</div>
          ...
          <div class="card-box" >
            <div class="card-font"  @click="toModuleResponsible">其他</div>
            <div class="card-border-box">
              <div class="line"></div>
              <div class="line1"></div>
              <div class="line2"></div>
          ...
          <div class="card-box" >
            <div class="card-font"  @click="toModuleResponsible">淘宝淘系</div>
            <div class="card-border-box">
              <div class="line"></div>
              <div class="line1"></div>
              <div class="line2"></div>
             ...
             <div class="card-box">
            <div class="card-font"  @click="toModuleResponsible">天猫平台</div>
            <div class="card-border-box">
              <div class="line"></div>
              <div class="line1"></div>
              <div class="line2"></div>
          ...
          <div class="card-box" >
            <div class="card-font"  @click="toModuleResponsible">天猫电商</div>
            <div class="card-border-box">
              <div class="line"></div>
              <div class="line1"></div>
              <div class="line2"></div>
